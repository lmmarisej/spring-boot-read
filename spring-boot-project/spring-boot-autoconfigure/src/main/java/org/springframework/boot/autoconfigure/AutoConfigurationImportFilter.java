 ...
 * @since 1.5.0
 *
 * 可以在spring.factories中注册过滤器，在实例化之前快速排除不需要的自动配置。
 */
@FunctionalInterface
public interface AutoConfigurationImportFilter {
	 ...
	 * @param autoConfigurationClasses the auto-configuration classes being considered.		待过滤的自动配置类数组
	 * This array may contain {@code null} elements. Implementations should not change the
	 * values in this array.
	 * @param autoConfigurationMetadata access to the meta-data generated by the   自动配置的元数据信息。
